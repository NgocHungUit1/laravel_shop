      ...
      <table class="table table-striped b-t b-light">
        ...
        @foreach($order_details as $key => $details)
          ...
          <tr class="color_qty_{{$details->product_id}}">
            ...
            <td>{{number_format((int)$details->product_feeship ,0,',','.')}}đ</td>
            ...
            <td>{{number_format((int)$details->product_price ,0,',','.')}}đ</td>
          ...
          <tr>
            ...
            @php
              ...
              @if($coupon_condition==1)
                  ...
                  echo 'Tổng giảm coupon :'.number_format($total_after_coupon,0,',','.').'</br>';
                  $total_coupon = $total + $details->product_feeship - $total_after_coupon ;
                  @endphp
              @else
                  @php
                  echo 'Tổng giảm coupon :'.number_format($coupon_number,0,',','.').'k'.'</br>';
