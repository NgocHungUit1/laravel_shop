...
class OrderController extends Controller
{
    ...
    public function print_order_convert($order_code)
    {
        ...
        $output .= '<tr>
                    <td colspan="2">
                        <p>Tổng giảm coupon: ' . $coupon_echo . '</p>
    ...
    public function view_order($order_code)
    {
        ...
        return view('admin.order.view_order')->with(compact('order_details_product', 'customerr', 'shipping', 'order_details', 'coupon_condition', 'coupon_number', 'orderr', 'order_status'));
    }
    public function manage_order()
    {
        $orderr = Order::orderby('created_at', 'DESC')->paginate(5);
        return view('admin.order.manage_order')->with(compact('orderr'));
    }
    public function history(Request $request)
    {
        if (!Session::get('customer_id')) {
            ...
            $orderr = Order::where('customer_id', Session::get('customer_id'))->orderby('order_id', 'DESC')->paginate(15);
        }
        return view('pages.history.history')->with(compact('cate', 'brand', 'all_product', 'all', 'slider', 'orderr'));
    }
    public function view_history_order(Request $request, $order_code)
    {
        ...
        return view('pages.history.view_history_order')->with(compact('cate', 'brand', 'all_product', 'all', 'slider', 'orderr','order_details_product', 'customerr', 'shipping', 'order_details', 'coupon_condition', 'coupon_number', 'orderr', 'order_status'));
    }
}
