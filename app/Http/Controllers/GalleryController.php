...
class GalleryController extends Controller
{
   ...
   ';
        if ($gallery_count > 0) {
           ...
           <td><img src="' . url('public/uploads/gallery/' . $gal->gallery_image) . '" class "img-thumbnail" width="120" height="130"></td>

           <td>
           <input type="file" class="file-image" style="width:40%" data-gal_id="'. $gal->gallery_id . '" id="file-'. $gal->gallery_id . '" name="file[]" accept="image/*" >
